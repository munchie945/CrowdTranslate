...
import edu.rosehulman.manc.crowdtranslate.adapter.ProjectListAdapter;
...
public class ManageProjectsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        projectList = getIntent().getParcelableArrayListExtra(LandingActivity.EXTRA_PROJECTS_KEY);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_manage_projects, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            RecyclerView recyclerView = (RecyclerView)rootView.findViewById(R.id.manage_projects_recycler_view);
            recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
            recyclerView.setHasFixedSize(true);
            mAdapter = new ProjectListAdapter(new ArrayList<Project>(),getActivity());
...
//            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
        ...
        public void displayInfo(Project project, int position) {
            Intent projectInfoIntent = new Intent(getActivity(), ProjectInfoActivity.class);
            projectInfoIntent.putExtra(EXTRA_PROJECT, project);
            projectInfoIntent.putExtra(EXTRA_PROJECT_INDEX, position);
